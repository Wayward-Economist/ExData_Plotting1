...
dev.copy(png, file = "plot1.png") # Note that the defults are 480 pixels x 480 pixels so no additional options are needed to satisfy the assignment requirements.
dev.off()